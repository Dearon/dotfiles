...
load+=(["foreground"]="#BCBCBC")
load+=(["background"]="#585858")
...
date_day+=(["foreground"]="#303030")
date_day+=(["background"]="#D0D0D0")
...
date_full+=(["foreground"]="#303030")
date_full+=(["background"]="#D0D0D0")
...
time+=(["foreground"]="#303030")
time+=(["background"]="#D0D0D0")
